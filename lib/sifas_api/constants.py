CURRENT_VERSION_WW = '10294'

CURRENT_VERSION_NAME_WW = '2.1.0'

VERSION_CONSTANTS_WW = {'keys': [
    0x70767d5a, 0x4c8f2f27, 0x61b66177,
],
    ...
    'ep': 2023, 'fullEp': 'https://gl-real-prod-8f2jln5l4evlw5l1.api.game25.klabgames.net/ep2023',
    'sessionKey': bytes.fromhex('75667a5369624d716459397232764448'), 'dbStr': "x'B73DA9C0EE7116836995B5ACED4AA33B095ECAF77B33605833FD759E6E743F1D'", 'versionName': '2.2.0', 'version': '7347',
...
CURRENT_VERSION_JP = '10177'

CURRENT_VERSION_NAME_JP = '2.3.0'

VERSION_CONSTANTS_JP = {'keys': [
    0x379b464a, 0x233d6180, 0x3af0c846,
],
    ...
    'ep': 2030, 'fullEp': 'https://jp-real-prod-v4tadlicuqeeumke.api.game25.klabgames.net/ep2030',
    'sessionKey': bytes.fromhex('64416f4f79577a6b794956666c434561'), 'dbStr': "x'B73DA9C0EE7116836995B5ACED4AA33B095ECAF77B33605833FD759E6E743F1D'", 'versionName': '2.2.0', 'version': '34',
    'cert': b'''-----BEGIN PUBLIC KEY-----
MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC/ZUSWq8LCuF2JclEp6uuW9+yd
dLQvb2420+F8rxIF8+W53BiF8g9m6nCETdRw7RVnzNABevMndCCTD6oQ6a2w0Qpo
KeT26578UCWtGp74NGg2Q2fHYFMAhTytVk48qO4ViCN3snFs0AURU06niM98MIcE
