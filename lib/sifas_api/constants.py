...
CURRENT_VERSION_NAME_WW = '3.11.0'

VERSION_CONSTANTS_WW = {'keys': [
    0x06856c49, 0x3aa19541, 0x5f13a7c1,
],
    ...
    'ep': 3110, 'fullEp': 'https://gl-real-prod-8f2jln5l4evlw5l1.llas.bushimo.jp/ep3110',
    'sessionKey': bytes.fromhex('51335961734f6477416b4e6832476d5a'), 'dbStr': "x'B73DA9C0EE7116836995B5ACED4AA33B095ECAF77B33605833FD759E6E743F1D'", 'versionName': '3.11.0', 'version': '7347',
...
CURRENT_VERSION_NAME_JP = '3.11.0'
...
VERSION_CONSTANTS_JP = {'keys': [
    ...
    'ep': 3110, 'fullEp': 'https://jp-real-prod-v4tadlicuqeeumke.llas.bushimo.jp/ep3110',
    'sessionKey': bytes.fromhex('755761626f72353645486b4d33307149'), 'dbStr': "x'B73DA9C0EE7116836995B5ACED4AA33B095ECAF77B33605833FD759E6E743F1D'", 'versionName': '3.11.0', 'version': '34',
    'cert': b'''-----BEGIN PUBLIC KEY-----
MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC/ZUSWq8LCuF2JclEp6uuW9+yd
dLQvb2420+F8rxIF8+W53BiF8g9m6nCETdRw7RVnzNABevMndCCTD6oQ6a2w0Qpo
KeT26578UCWtGp74NGg2Q2fHYFMAhTytVk48qO4ViCN3snFs0AURU06niM98MIcE
